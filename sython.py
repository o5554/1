...
c = requests.session()
bot_username = '@eeobot'
bot_usernamee = '@MHDN313bot'
bot_usernamee = '@Ershkalibot'
...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@l_5_4"))
...
@sython.on(events.NewMessage(outgoing=False, pattern='.حمودي'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
       order = await event.reply('هنا يمك حمودي ابشر @l_5_4')
...
async def _(event):
        ...
        await sython.send_message('@eeoBOT', 'جاري التجميع بواسطة | mohamdyon TEAM')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        await event.edit("حسنا, تأكد من انك مشترك ب قنوات الاشتراك الاجباري لتجنب الأخطأء")
        channel_entity = await sython.get_entity(bot_username)
        await sython.send_message('@Ershkalibot', 'جاري التجميع بواسطة | mohamdyon TEAM')
        channel_entity = await sython.get_entity(bot_username)
...
@sython.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع مهدويون"))
async def _(event):
        await event.edit("حسنا, تأكد من انك مشترك ب قنوات الاشتراك الاجباري لتجنب الأخطأء")
        channel_entity = await sython.get_entity(bot_usernamee)
        await sython.send_message('@MHDN313bot', 'جاري التجميع بواسطة | mohamdyon TEAM')
        channel_entity = await sython.get_entity(bot_usernamee)
        await sython.send_message('@MHDN313bot', '/start')
        await asyncio.sleep(5)
        msg0 = await sython.get_messages('@MHDN313bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sython.get_messages('@MHDN313bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await sython(ImportChatInviteRequest(bott))
                msg2 = await sython.get_messages('@MHDN313bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@hc_c8"))
    except BaseException:
        pass
...
async def _(event):
      await event.reply("""السـورس يعمـل |محمديون
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
@sython.on(events.NewMessage(outgoing=True, pattern=".المطور"))
async def _(event):
      await event.reply("""حمودي : @l_5_4"""
)
